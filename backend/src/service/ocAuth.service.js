const { isOcNotInstalledError, runOcCommand } = require("./ocCommand.service");

const OC_NOT_INSTALLED_ERROR =
	"oc CLI is not installed or not available in PATH";
const OC_NOT_INSTALLED_ACTION =
...
const OC_NOT_LOGGED_IN_ACTION =
	"Run oc login in a terminal, then refresh LogPulse.";
